...
public class WeakPassword_NoDigitTest extends BaseTest {
    ...
    public void testPasswordMissingDigit() {
        ...
        RegistrationPage page = new RegistrationPage()
                ...
                .enterPassword("Password")  // لا يحتوي على أرقام
                .clickRegister();
        ...
        Assert.assertTrue(
                ...
                "Expected validation warning for missing digit but got: " + validationMessage
        );
    }
}
